...
/******/ 			var chunk = require("./" + ({"1":"components/dashboard","2":"components/header-component","3":"components/nuxt-logo","4":"components/subheader","5":"components/tutorial","6":"pages/index"}[chunkId]||chunkId) + ".js");
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(4).default("489c7142", content, true)
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, "body{background-color:#0d1118}.row{padding:24px 0}h1,h2,h3,h4,h5,h6{margin-bottom:0}.table td{border:unset}.title{color:#fff;font-size:32px}.subtitle{color:#a4b0cb;font-size:24px;font-weight:400}.blue{color:#00ceff}.btn{color:#fff;font-weight:700;font-size:14px}.btn.pill{border-radius:32px;background-color:transparent;color:#a4b0cb}.btn.pill.active{background-color:#0075ff;color:#fff}.date-filters{justify-content:flex-end;display:inline-flex;margin:0 12px;background-color:#141c25;padding:8px 20px;border-top-left-radius:12px;border-top-right-radius:12px;align-items:center}.dashboard-filter-btn{font-weight:500;font-size:14px;background-color:transparent;border:1px solid transparent;color:#fff;border-radius:4px}.dashboard-filter-btn:hover{border-color:#0075ff}.text{font-size:16px}.bold{font-weight:700}.text-label{font-weight:400;font-size:14px;color:#636f80}.white{color:#fff}.icon{font-size:16px;display:block;height:16px;width:16px;line-height:normal}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
__webpack_require__.d(components_namespaceObject, "Subheader", function() { return Subheader; });
...
const _3b7100db = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 6).then(__webpack_require__.bind(null, 56)));
...
var scss_global = __webpack_require__(36);
...
const NuxtLogo = () => __webpack_require__.e(/* import() | components/nuxt-logo */ 3).then(__webpack_require__.bind(null, 60)).then(c => wrapFunctional(c.default || c));
const Tutorial = () => __webpack_require__.e(/* import() | components/tutorial */ 5).then(__webpack_require__.bind(null, 57)).then(c => wrapFunctional(c.default || c));
const Dashboard = () => __webpack_require__.e(/* import() | components/dashboard */ 1).then(__webpack_require__.bind(null, 46)).then(c => wrapFunctional(c.default || c));
const HeaderComponent = () => __webpack_require__.e(/* import() | components/header-component */ 2).then(__webpack_require__.bind(null, 58)).then(c => wrapFunctional(c.default || c));
const Subheader = () => __webpack_require__.e(/* import() | components/subheader */ 4).then(__webpack_require__.bind(null, 59)).then(c => wrapFunctional(c.default || c)); // nuxt/nuxt.js#8607
...
var external_vue_apollo_ = __webpack_require__(10);
...
var polyfill_ = __webpack_require__(38);

// EXTERNAL MODULE: external "apollo-client"
var external_apollo_client_ = __webpack_require__(16);

// EXTERNAL MODULE: external "apollo-link"
var external_apollo_link_ = __webpack_require__(5);

// EXTERNAL MODULE: external "apollo-upload-client"
var external_apollo_upload_client_ = __webpack_require__(17);

// EXTERNAL MODULE: external "apollo-cache-inmemory"
var external_apollo_cache_inmemory_ = __webpack_require__(6);

// EXTERNAL MODULE: external "subscriptions-transport-ws"
var external_subscriptions_transport_ws_ = __webpack_require__(18);

// EXTERNAL MODULE: external "subscriptions-transport-ws/dist/message-types"
var message_types_ = __webpack_require__(19);
var message_types_default = /*#__PURE__*/__webpack_require__.n(message_types_);

// EXTERNAL MODULE: external "apollo-link-ws"
var external_apollo_link_ws_ = __webpack_require__(20);

// EXTERNAL MODULE: external "apollo-utilities"
var external_apollo_utilities_ = __webpack_require__(21);

// EXTERNAL MODULE: external "apollo-link-persisted-queries"
var external_apollo_link_persisted_queries_ = __webpack_require__(22);

// EXTERNAL MODULE: external "apollo-link-context"
var external_apollo_link_context_ = __webpack_require__(23);

// EXTERNAL MODULE: external "apollo-link-state"
var external_apollo_link_state_ = __webpack_require__(24);
...
var external_universal_cookie_ = __webpack_require__(25);
...
/* harmony default export */ var apollo_module = ((ctx, inject) => {
  ...
  const vueApolloOptions = Object.assign(providerOptions, {
    errorHandler(error) {
      return __webpack_require__(39).default(error, ctx);
    }
  ...
  if (true) {
    const ApolloSSR = __webpack_require__(40);
